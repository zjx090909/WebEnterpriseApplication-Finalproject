/**
 * This package contains the presentation layer classes for the Bouncer application.
 */
package cst8218.jianxia.bouncer.presentation;

import cst8218.jianxia.bouncer.entity.Bouncer;
import cst8218.jianxia.bouncer.presentation.util.JsfUtil;
import cst8218.jianxia.bouncer.presentation.util.PaginationHelper;
import cst8218.jianxia.bouncer.entity.BouncerFacade;
...
/**
 * This controller manages the presentation layer operations related to the Bouncer entity.
 * 
 * It provides functionality for listing, creating, editing, and deleting Bouncers.
 * 
 * @author zhangjianxia
 */
...
public class BouncerController implements Serializable {
    ...
    @EJB
    private cst8218.jianxia.bouncer.entity.BouncerFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    /**
     * constructor for BouncerController
     */
    public BouncerController() {
    }
    /**
     * Get the bouncer entity which has been selected
     * @return bouncer entity
     */
    ...
    /**
     * Get the facade for bouncer entity
     * @return The BouncerFacade instance
     */
